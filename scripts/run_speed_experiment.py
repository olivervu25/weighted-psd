...
def main():
    ...
    ns = [100, 500, 1000, 2000, 5000, 7000, 10000]
    d = 10
    J = 10
    reps = args.rounds
    ...
    metrics = OrderedDict([
        ('RFSD', make_divergence_call(rfsd.L1IMQFastKSD(p, d=d))),
        ('IMQ KSD', make_divergence_call(rfsd.KSD(kernel.KIMQ(), p))),
        ('PSD r1', make_divergence_call(rfsd.PSD(1,p))),
        ('PSD r2', make_divergence_call(rfsd.PSD(2,p))),
        ('PSD r3', make_divergence_call(rfsd.PSD(3,p))),
        ('PSD r4', make_divergence_call(rfsd.PSD(4,p)))
        ])
