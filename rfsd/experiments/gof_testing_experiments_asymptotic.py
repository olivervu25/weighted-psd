...
from rfsd.goftest import RFDH0SimCovDrawV, RFDGofTest, PolynomialSteinTest, PSDH0SimCovDraw
...
def single_gof_testing_round(test_names, case, gamma, test_alpha, J):
    ...
    psd1_null_sim = PSDH0SimCovDraw(n_draw=5000, seed=sim_seed, fromp=False)
    psd2_null_sim = PSDH0SimCovDraw(n_draw=5000, seed=sim_seed, fromp=False)
    psd3_null_sim = PSDH0SimCovDraw(n_draw=5000, seed=sim_seed, fromp=False)
    psd4_null_sim = PSDH0SimCovDraw(n_draw=5000, seed=sim_seed, fromp=False)
    ...
    possible_tests = {    'RFSD (alpha)' : RFDGofTest(p, rfd_imq, null_sim=l1_rfd_null_sim, alpha=test_alpha),
                          ...
                          'PSD r1' : PolynomialSteinTest(p, 1, alpha=test_alpha, seed=None, bootstrap = False, null_sim = psd1_null_sim),
                          'PSD r2' : PolynomialSteinTest(p, 2, alpha=test_alpha, seed=None, bootstrap = False, null_sim = psd2_null_sim),
                          'PSD r3' : PolynomialSteinTest(p, 3, alpha=test_alpha, seed=None, bootstrap = False, null_sim = psd3_null_sim),
                          'PSD r4': PolynomialSteinTest(p, 4, alpha=test_alpha, seed=None, bootstrap = False, null_sim = psd4_null_sim)
    }
    if 'Gauss FSSD-opt' in test_names:
